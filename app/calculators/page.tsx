...
import { Calculator, TrendingDown, DollarSign, Home, RefreshCw, PiggyBank } from "lucide-react";
...
const calculators = [
  ...
  },
  {
    ...
    icon: PiggyBank,
    whoFor: "Anyone with a mortgage or loan",
    answers: "Should I pay extra or invest instead?",
