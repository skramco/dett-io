...
import { getAllDefinitionSlugs } from '@/lib/definitions/definitionData';

const definitionSlugs = new Set(getAllDefinitionSlugs());
          ...
          <Container maxWidth="lg">
            <Stack spacing={4}>
              ...
              <Box sx={{ 
                ...
                {[
                  { term: 'Amortization', def: 'The process of paying off a loan over time through regular payments that cover both principal and interest.', slug: 'amortization' },
                  { term: 'APR (Annual Percentage Rate)', def: 'The yearly cost of a loan including interest and fees, expressed as a percentage.', slug: 'apr' },
                  ...
                  { term: 'Closing Costs', def: 'Fees and expenses paid at the closing of a real estate transaction, typically 2-5% of the purchase price.', slug: 'closing-costs' },
                  { term: 'Conventional Loan', def: 'A mortgage not insured or guaranteed by the federal government.', slug: 'conventional-loan' },
                  { term: 'Debt-to-Income Ratio (DTI)', def: 'The percentage of your monthly income that goes toward debt payments. Lenders use this to assess loan eligibility.', slug: 'dti' },
                  { term: 'Down Payment', def: 'The upfront cash payment made when purchasing a home, typically 3-20% of the purchase price.' },
                  { term: 'Equity', def: 'The difference between your home\'s current market value and the amount you owe on your mortgage.', slug: 'equity' },
                  { term: 'Escrow', def: 'An account where funds are held by a third party to pay property taxes and insurance on behalf of the homeowner.', slug: 'escrow' },
                  { term: 'FHA Loan', def: 'A mortgage insured by the Federal Housing Administration, allowing lower down payments and credit scores.', slug: 'fha-loan' },
                  ...
                  { term: 'Loan-to-Value Ratio (LTV)', def: 'The ratio of the loan amount to the property\'s value, expressed as a percentage.', slug: 'ltv' },
                  { term: 'Mortgage Points', def: 'Upfront fees paid to the lender to reduce your interest rate. One point equals 1% of the loan amount.', slug: 'mortgage-points' },
                  { term: 'Mortgage Recast', def: 'Recalculating your monthly payment after making a large principal payment, without refinancing.', slug: 'mortgage-recast' },
                  { term: 'PITI', def: 'Principal, Interest, Taxes, and Insurance - the four components of a typical monthly mortgage payment.', slug: 'piti' },
                  { term: 'PMI (Private Mortgage Insurance)', def: 'Insurance required by lenders when down payment is less than 20%, protecting the lender if you default.', slug: 'pmi' },
                  ...
                  { term: 'Refinance', def: 'Replacing your current mortgage with a new one, typically to get a better interest rate or change loan terms.', slug: 'refinance' },
                  ...
                  { term: 'VA Loan', def: 'A mortgage guaranteed by the Department of Veterans Affairs, available to eligible veterans and service members.', slug: 'va-loan' },
                  ...
                  const hasPage = item.slug && definitionSlugs.has(item.slug);
                  const card = (
                    <Box 
                      key={index}
                      sx={{ 
                    ...
                    >
                      <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
                        ...
                        {hasPage && <ArrowForward sx={{ fontSize: 16, color: 'primary.main', mt: 0.5, flexShrink: 0 }} />}
                      </Stack>
                  ...
                  if (hasPage) {
                    return (
                      <Link key={index} href={`/learn/${item.slug}`} style={{ textDecoration: 'none' }}>
                        {card}
                      </Link>
                    );
                  }
